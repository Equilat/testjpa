...
public class DaoSondage {
    ...
    public List<Sondage> findAll() {
        return EntityManagerHelper.getEntityManager().createQuery("select u from Sondage as u", Sondage.class).getResultList();
    }

    public List<Sondage> findById(String id) {
        return EntityManagerHelper.getEntityManager().createQuery("select u from Sondage as u where u.id = :id", Sondage.class)
                .setParameter("id", id).getResultList();
    }

//    public List<Sondage> getSondagesFromType(String type) {
//        return EntityManagerHelper.getEntityManager().createQuery("select u from Sondage as u where u. = :type", Sondage.class)
